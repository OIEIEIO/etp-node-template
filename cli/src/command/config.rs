...
pub struct Configuration {
	...
	// /// Enable authoetp even when offline.
	// pub force_authoetp: bool,
	...
	// pub dev_key_seed: Option<Stetp>,
	// /// Tracing targets
	// pub tracing_targets: Option<Stetp>,
	// /// Tracing receiver
