//! DNA-specific RPCs implementation.
...
// --- DNA ---
use DNA_primitives::{AccountId, Balance, Block, BlockNumber, Hash, Nonce, Power};
...
where
	...
	C::Api: DNA_balances_rpc::BalancesRuntimeApi<Block, AccountId, Balance>,
	C::Api: DNA_staking_rpc::StakingRuntimeApi<Block, AccountId, Power>,
	...
	SC: 'static + sp_consensus::SelectChain<Block>,
{
	...
	// --- DNA ---
	use DNA_balances_rpc::{Balances, BalancesApi};
	use DNA_staking_rpc::{Staking, StakingApi};
