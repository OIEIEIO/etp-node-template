//! A set of constant values used in dna-network runtime.

/// Money matters.
pub mod currency {
	// --- DNA ---
	use DNA_primitives::{Balance, Power};
...
pub mod time {
	...
	// --- DNA ---
	use DNA_primitives::{BlockNumber, Moment};
...
pub mod fee {
	...
	use DNA_primitives::Balance;
	use DNA_runtime_common::ExtrinsicBaseWeight;
	...
	impl Convert<Weight, Balance> for WeightToFee {
		fn convert(x: Weight) -> Balance {
			// in dna-network, extrinsic base weight (smallest non-zero weight) is mapped to 100 MILLI:
